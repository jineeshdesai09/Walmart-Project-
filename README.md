...
<h1>WALMART-PROJECT-MERN</h1>
<p><em>Transforming Shopping into Seamless, Limitless Experiences</em></p>

<img alt="last-commit" src="https://img.shields.io/github/last-commit/jineeshdesai09/Walmart-Project-MERN?style=flat&amp;logo=git&amp;logoColor=white&amp;color=0080ff" class="inline-block mx-1" style="margin: 0px 2px;">
<img alt="repo-top-language" src="https://img.shields.io/github/languages/top/jineeshdesai09/Walmart-Project-MERN?style=flat&amp;color=0080ff" class="inline-block mx-1" style="margin: 0px 2px;">
<img alt="repo-language-count" src="https://img.shields.io/github/languages/count/jineeshdesai09/Walmart-Project-MERN?style=flat&amp;color=0080ff" class="inline-block mx-1" style="margin: 0px 2px;">
...
<hr>
<h2>Overview</h2>
<p>Walmart-Project-MERN is a comprehensive full-stack e-commerce platform built with the MERN stack, designed to accelerate your development process. The core features include:</p>
<ul class="list-disc pl-4 my-0">
...
<h3>Installation</h3>
<p>Build Walmart-Project-MERN from the source and install dependencies:</p>
<ol>
<li class="my-0">
<p><strong>Clone the repository:</strong></p>
<pre><code class="language-sh">❯ git clone https://github.com/jineeshdesai09/Walmart-Project-MERN
</code></pre>
</li>
<li class="my-0">
<p><strong>Navigate to the project directory:</strong></p>
<pre><code class="language-sh">❯ cd Walmart-Project-MERN
</code></pre>
</li>
<li class="my-0">
...
<h3>Testing</h3>
<p>Walmart-project-mern uses the {<strong>test_framework</strong>} test framework. Run the test suite with:</p>
<p><strong>Using <a href="https://www.npmjs.com/">npm</a>:</strong></p>
